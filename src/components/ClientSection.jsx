...
const ClientsSection = () => {
  return (
    <section className="bg-[#0f0f0f] text-white lg:min-h-screen flex items-center justify-center p-16">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-center">
        ...
        <div className="w-full md:w-1/3 flex justify-center md:justify-start items-center text-center md:text-left mb-12 md:mb-0 md:pl-12">
          <h2 className="text-4xl md:text-4xl leading-tight font-medium font-barlow">
            Working With the <br />
            Best Clients and <br />
            Partners
          </h2>
